...
import (
	...
	"github.com/anwendt/imagebuilder/pkg/provisioner/puppet"
	"github.com/anwendt/imagebuilder/pkg/provisioner/sshutil"
)

func TestProvisioner_Run_UploadsInlineManifestAndRunsPuppetApply(t *testing.T) {
	workspace := t.TempDir()
	...
	if !containsString(runner.commands[1].Args, "sudo puppet apply /tmp/imagebuilder-puppet.pp") {
