...
func (p *SDKProvider) Capabilities(context.Context) (sdk.Capabilities, error) {
	...
	return sdk.Capabilities{ProviderName: plugin.Name(), ProviderVersion: plugin.Version(), Formats: formats, OSFamilies: families, BuildModes: plugin.SupportedBuildModes()}, nil
}
