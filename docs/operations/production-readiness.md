...
```bash
make docker-push-core REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.2
make docker-digest-core REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.2
...
```bash
make docker-push-provider-aws REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.2
...
make docker-push-provider-openstack REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.2
