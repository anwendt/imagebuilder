...
```bash
make docker-push-core REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.1
make docker-digest-core REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.1
...
make docker-push-provider-vsphere REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.1
...
make docker-push-provider-openstack REGISTRY=ghcr.io/anwendt IMAGE_TAG=v0.4.1
