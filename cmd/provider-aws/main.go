...
import (
	...
	"github.com/anwendt/imagebuilder/plugins/aws"
)
...
func main() {
	...
	slog.Info("starting aws provider", slog.String("address", listen))
	if err := sdk.Serve(context.Background(), listener, aws.NewSDKProvider(), serverOptions...); err != nil {
