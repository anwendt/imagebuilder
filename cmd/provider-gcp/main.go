...
import (
	...
	"github.com/anwendt/imagebuilder/plugins/gcp"
)
...
func main() {
	...
	slog.Info("starting gcp provider", slog.String("address", listen))
	if err := sdk.Serve(context.Background(), listener, gcp.NewSDKProvider(), serverOptions...); err != nil {
